...
int main() 
{
    ...
    if (choice == 1) 
    {
        ...
        // Question 1
        printf("\nQuestion 1:\n");
        printf("Current Indian Prime Minister? \n");
        ...
        // Question 2
        printf("\nQuestion 2:\n");
        printf("Who is Finance Minister of India?\n");
        printf("1. Shushma Swaraj \n 2. Arun Jetly \n 3. Rajnath Singh \n 4. Nirmala Sitaraman\n");
        printf("Please enter your answer: ");
        scanf("%d", &answer);
        ...
        // Question 4
        printf("\nQuestion 4:\n");
        printf("Who is current External Affairs Minister of India?\n");
        printf("1. S Jaishankar\n 2. J.P. Nadda \n 3.Om Birla \n 4. Shushma Swaraj \n");
        printf("Please enter your answer: ");
        scanf("%d", &answer);
        ...
        // Question 5
        printf("\nQuestion 5:\n");
        printf("How many States are in India?\n");
        printf("1. 30 \n 2.29 \n 3.28 \n 4. 27\n");
        printf("Please enter your answer: ");
        scanf("%d", &answer);
